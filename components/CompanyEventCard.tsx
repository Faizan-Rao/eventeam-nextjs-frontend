...
const CompanyEventCard = () => {
  return (
    <div className="bg-[white]  hover:translate-y-[-30%] transition-all duration-300 flex-1 flex flex-col p-6  rounded-3xl translate-y-[-25%] min-w-[400px]  ">
      <span className="bg-[#7655fa26]  text-base mb-4 mt-2 px-4 py-2 self-start text-center  rounded-full text-[#7655fa] font-semibold">
        Upcoming
      </span>
      <h1 className="font-semibold text-xl mb-2">
        New {"Year's"} Eve Celebration
      </h1>
      <p className=" text-[#999999] pb-4 border-b-[1px] ">
      ...
      <div className="flex my-2 justify-between items-center">
        ...
        <button className="bg-[#7655fa26] text-sm  px-3  mt-2  text-center p-2 rounded-full text-[#7655fa] font-semibold">
          View Details
        </button>
      </div>
      ...
      <div className="flex flex-1 pb-4 border-b-[1px] max-h-[140px] justify-stretch">
        <span className=" flex-1 p-4 flex-col flex justify-center items-center rounded-md gap-4 bg-[#7655fa26]">
          ...
          <span className="text-[#999999] text-lg font-semibold">
            Start at 00:00
          </span>
        </span>
      </div>
